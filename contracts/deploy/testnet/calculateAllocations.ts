...
const ALLOCATIONS_PATH = '././configs/mainnet_mock_allocations.json'
...
const func: DeployFunction = async (hre) => {
    ...
    const fromBlock = 24148424 // avax testnet
    // const fromBlock = 17721707 // eth mainnet

    const toBlock = 24300355
    ...
    for (let i = 0; i < (toBlock - fromBlock) / 1000; ++i) {
        promises.push(
            presale.queryFilter(
                filter,
                fromBlock + i * 1000,
